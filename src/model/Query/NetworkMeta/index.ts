...
export class NetworkMeta {
  ...
  async fetch(
    ...
    const networkMeta = await api.queryMulti([
      ...
      api.query.balances.totalIssuance, //this.api.query.auctions.auctionCounter,
      api.query.balances.totalIssuance, //this.api.query.paraSessionInfo.earliestStoredSession,
      api.query.balances.totalIssuance, //this.api.query.fastUnstake.erasToCheckPerBlock,
